...
import datetime
import hashlib
from ui.console import Console  # <- updated

DATA_FILE = "evoting_data.json"

console = Console()  # single console instance

class DataStore:
    """Central data store. All service classes receive a reference to this instance — they never keep their own copies of the data dicts."""
    ...
    def save(self):
        ...
        try:
            ...
            console.print_info("Data saved successfully")
        except Exception as exc:
            console.print_error(f"Error saving data: {exc}")
    ...
    def load(self):
        ...
        try:
            ...
            console.print_info("Data loaded successfully")
        except Exception as exc:
            console.print_error(f"Error loading data: {exc}")